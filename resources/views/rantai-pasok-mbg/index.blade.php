...
<aside class="sidebar" data-sidebar>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('mbg.index') }}" class="sidebar-link"><x-sidebar-icon name="gudang" /><span>Gudang & Logistik</span></a>
        <a href="{{ route('mbg.index') }}" class="sidebar-link"><x-sidebar-icon name="penerima-manfaat" /><span>Penerima Manfaat</span></a>
    ...
    if (trendCtx) {
        new Chart(trendCtx, {
            ...
            data: {
                ...
                datasets: [
                    { data: [2200,2350,2480,2620,2740,2850], borderColor: '#1267ff', pointBackgroundColor: '#1267ff', pointBorderColor: '#fff', pointBorderWidth: 2, pointRadius: 4, borderWidth: 3, tension: .34 },
                    { data: [1950,2150,2220,2380,2500,2430], borderColor: '#22c55e', pointBackgroundColor: '#22c55e', pointBorderColor: '#fff', pointBorderWidth: 2, pointRadius: 4, borderWidth: 3, tension: .34 }
                ]
            },
            options: {
                ...
                scales: {
                    x: { grid: { display: false }, ticks: { color: '#062a70', font: { family: 'Inter', size: 10, weight: 600 } }, border: { color: '#9fb8dc' } },
                    y: { min: 0, max: 4000, ticks: { stepSize: 1000, color: '#062a70', font: { family: 'Inter', size: 10, weight: 600 }, callback: (v) => v.toLocaleString('id-ID') }, grid: { color: '#dce7f7' }, border: { display: false } }
                }
            }
        });
    }

...
<body class="h-screen w-screen overflow-hidden antialiased text-[#001f4f]">
        ...
        <div class="absolute bottom-[12px] right-[48px] top-[28px] z-30 flex w-[44vw] min-w-[680px] max-w-[840px] flex-col rounded-[24px] bg-white shadow-[0_8px_40px_rgb(0,0,0,0.08)]">
            ...
            <div class="absolute left-0 right-0 top-[260px] mx-auto flex w-[610px] max-w-[72%] flex-col">
                ...
                <form method="POST" action="{{ route('login') }}" class="flex w-full flex-col gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2.5 flex justify-end">
                            <a href="#" class="cursor-pointer text-[14px] font-bold text-[#004dff] hover:underline">Lupa Password?</a>
                        </div>
                    </div>

                    <!-- Submit Button -->
                    <button type="submit" class="mt-1 flex h-[62px] w-full cursor-pointer items-center justify-center gap-3 rounded-lg bg-[#001f4f] text-[16px] font-bold text-white transition hover:bg-[#001536]">
                    ...
                    <!-- Google Button -->
                    <button type="button" class="flex h-[58px] w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-[#cfd8e3] bg-white text-[15px] font-bold text-[#333333] transition hover:bg-gray-50">
                ...
                <p class="mt-8 text-center text-[14.5px] font-medium text-gray-500">
                    Belum punya akun? <a href="#" class="cursor-pointer font-bold text-[#004dff] hover:underline">Hubungi Administrator Desa</a>
                </p>
            </div>
        </div>
    </main>
    ...
    <!-- Footer -->
    <footer class="absolute bottom-0 left-0 right-0 z-50 h-[94px] bg-[var(--sidebar-bg)]">
        ...
        <div class="flex h-full w-full items-center gap-[50px] px-[50px] xl:gap-[80px] xl:px-[70px] 2xl:gap-[120px] 2xl:px-[80px] overflow-hidden whitespace-nowrap">
            <!-- Nakala Logo -->
            <div class="flex h-[62px] flex-shrink-0 items-center rounded-xl bg-white/95 px-4 shadow-[0_10px_28px_rgba(0,0,0,0.18)] ring-1 ring-white/20">
                <img src="{{ asset('assets/desahub/logo-nakala-transparent.png') }}" alt="Nakala Digital" class="h-[38px] object-contain xl:h-[42px] 2xl:h-[48px]">
            </div>
